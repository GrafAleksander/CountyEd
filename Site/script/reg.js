...
var buff_hr;
           ...
           function ExitFoundMode(){
             ...
             document.getElementById("foot_line").style.marginTop = "90px";
          ...
          function Start(){
                ...
                var style = getComputedStyle(outside_menu); 
                var width = parseFloat(style.width) + 11;
                outside_menu.style.marginLeft = 0- width + "px";
           } 
